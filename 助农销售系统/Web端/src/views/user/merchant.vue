...
<script>
import {addObj, delObj, fetchList, putObj} from "@/api/admin/merchant";
...
export default {
  ...
  methods: {
    ...
    handleOpenBefore(show, type) {
      ...
      //     this.role[i] = this.form.roleList[i].businessId;
      //   }
      //   this.post = []
    ...
    deletes(row) {
      this.$confirm(
          "此操作将永久删除该用户(用户名:" + row.storeName + "), 是否继续?"+row.businessId,
          "提示",
          {
