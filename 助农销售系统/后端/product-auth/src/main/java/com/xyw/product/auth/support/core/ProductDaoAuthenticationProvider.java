...
import com.xyw.product.auth.support.wechat.WechatAuthorizationGrantType;
import com.xyw.product.common.core.constant.SecurityConstants;
import com.xyw.product.common.core.util.WebUtils;
import com.xyw.product.common.security.service.ProductUserDetailsService;
...
public class ProductDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public ProductDaoAuthenticationProvider() {
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
		...
		if (StrUtil.equals(SecurityConstants.APP, grantType)
				|| StrUtil.equals(WechatAuthorizationGrantType.WX_CODE.getValue(), grantType)) {
			return;
		}
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		Map<String, ProductUserDetailsService> userDetailsServiceMap = SpringUtil
				.getBeansOfType(ProductUserDetailsService.class);

		String finalClientId = clientId;
		Optional<ProductUserDetailsService> optional = userDetailsServiceMap.values().stream()
		...
		try {
			...
			loadedUser = optional.get().loadUserByUsername(username);
			if (loadedUser == null) {
