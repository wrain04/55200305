package com.xyw.product.auth.endpoint;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.xyw.product.admin.api.entity.SysOauthClientDetails;
import com.xyw.product.admin.api.feign.RemoteClientDetailsService;
import com.xyw.product.admin.api.vo.TokenVo;
...
import com.xyw.product.common.core.util.RetOps;
...
import com.xyw.product.common.security.util.OAuth2ErrorCodesExpand;
import com.xyw.product.common.security.util.OAuthClientException;
...
public class ProductTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new ProductAuthenticationFailureEventHandler();
