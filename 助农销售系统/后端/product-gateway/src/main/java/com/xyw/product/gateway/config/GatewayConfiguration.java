...
import com.xyw.product.gateway.filter.PasswordDecoderFilter;
import com.xyw.product.gateway.filter.ProductRequestGlobalFilter;
import com.xyw.product.gateway.filter.SwaggerBasicGatewayFilter;
import com.xyw.product.gateway.filter.ValidateCodeGatewayFilter;
import com.xyw.product.gateway.handler.GlobalExceptionHandler;
...
public class GatewayConfiguration {
	...
	@Bean
	public ProductRequestGlobalFilter productRequestGlobalFilter() {
		return new ProductRequestGlobalFilter();
	}
