package com.xyw.product.gateway.filter;

import com.xyw.product.gateway.config.SpringDocConfiguration;
...
public class SwaggerBasicGatewayFilter implements GlobalFilter {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		if (hasAuth(exchange)) {
			...
			response.getHeaders().add(HttpHeaders.WWW_AUTHENTICATE, "Basic Realm=\"product\"");
