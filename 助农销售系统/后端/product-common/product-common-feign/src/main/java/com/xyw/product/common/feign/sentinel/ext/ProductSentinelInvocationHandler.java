...
@Slf4j
public class ProductSentinelInvocationHandler implements InvocationHandler {
	...
	ProductSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			ProductSentinelInvocationHandler other = (ProductSentinelInvocationHandler) obj;
