...
import com.xyw.product.admin.api.entity.*;
import com.xyw.product.admin.api.util.ParamResolver;
import com.xyw.product.admin.api.vo.UserExcelVO;
import com.xyw.product.admin.api.vo.UserVO;
import com.xyw.product.admin.mapper.*;
import com.xyw.product.admin.service.AppService;
import com.xyw.product.admin.service.SysMenuService;
...
import com.xyw.product.common.core.constant.enums.MenuTypeEnum;
...
import static com.xyw.product.common.core.constant.CommonConstants.BUSINESS_CODE;
j
@Service
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
	...
	public Boolean isBusiness(Long id) {
		return sysRoleMapper.listRolesByUserId(id).stream().map(SysRole::getRoleCode).collect(Collectors.toList())
				.contains(BUSINESS_CODE);
	}
